...
const App = (props) => {
    ...
    return (React.createElement("div", { className: 'c-app', tabIndex: -1, ref: app, onKeyDown: handleKeyPress },
        ...
        React.createElement(SidebarLeft, { selection: selection, setSelection: setSelection, setHover: setHover, groupSelection: groupSelection, setGroupSelection: setGroupSelection, groupSelectionNest: groupSelectionNest, setGroupSelectionNest: setGroupSelectionNest, artboard: props.artboard }),
