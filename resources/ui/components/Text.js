...
class Text extends React.Component {
    render() {
        ...
        return (React.createElement("div", { onClick: onClick, onMouseOver: onMouseOver, onMouseOut: onMouseOut, className: 'c-layer c-layer--text', 
            // @ts-ignore
            style: textContainerStyles(layer) }, paragraphs.map((string, index) => (React.createElement("p", { key: index, className: 'c-layer__text', style: Object.assign(Object.assign({}, textStyles(layer)), paragraphSpacing(layer, index === paragraphs.length - 1)) }, string.length === 0
