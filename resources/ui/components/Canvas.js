...
const Canvas = (props) => {
    ...
    return (React.createElement("div", { className: 'c-canvas', ref: canvas },
        ...
        React.createElement(CanvasEscape, { setSelection: props.setSelection, setHover: props.setHover, onClick: () => { var _a; return (_a = canvas.current) === null || _a === void 0 ? void 0 : _a.focus(); } })));
};
