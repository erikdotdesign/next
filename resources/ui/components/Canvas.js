...
const Canvas = (props) => {
    ...
    return (React.createElement("div", { className: 'c-canvas', id: 'canvas', ref: canvas },
        React.createElement(CanvasRules, { leftScroll: props.leftScroll, topScroll: props.topScroll, sectionSize: sectionSize, canvasSize: props.canvasSize, zoom: zoom, artboardWidth: props.artboard.frame.width * zoom, artboardHeight: props.artboard.frame.height * zoom }),
