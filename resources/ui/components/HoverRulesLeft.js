...
const HoverRulesLeft = (props) => {
    ...
    return (React.createElement("div", null,
        selectionOrigin.bottom < hoverOrigin.top
            ...
            ? React.createElement("div", { className: 'c-hover__rule c-hover__rule--lt', style: createRuleLeftStyles(hoverOrigin, selectionOrigin, zoom) })
            : null,
        selectionOrigin.top > hoverOrigin.bottom
            ...
            ? React.createElement("div", { className: 'c-hover__rule c-hover__rule--lb', style: createRuleLeftStyles(hoverOrigin, selectionOrigin, zoom) })
            : null));
};
